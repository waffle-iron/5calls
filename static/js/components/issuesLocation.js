...
module.exports = (state, prev, send) => {
  ...
  function addressForm(state) {
    ...
    return html`<p><form onsubmit=${submitAddress} class=${className}><input type="text" autofocus="true" id="address" name="address" placeholder="${t.getText("location.chooseALocation", null, true)}" /> <button>Go</button></form></p>`;
  }
